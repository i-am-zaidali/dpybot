# A VERY BLATANT AND SHAMELESS COPY OF redbot.core.utils.chat_formatting.py
# These are very useful :shrug:
...
def humanize_list(items: Sequence[str], *, style: str = "standard") -> str:
